...
function Header() {
  return (
    ...
    <h1 className="font-bold text-2xl max-w-2xl leading-snug">
    ...
    <button className='bg-black rounded-lg text-white font-semibold px-4 py-2 flex mt-4 hover:scale-110'> <div className='pr-2'> Connect </div> <svg  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 24 24">
